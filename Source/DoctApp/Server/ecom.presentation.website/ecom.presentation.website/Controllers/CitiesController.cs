...
namespace ecom.presentation.website.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NameEN,CountryID,IsActive")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NameEN,CountryID,IsActive")] City city)
        {
            if (ModelState.IsValid)
            {
