...
namespace ecom.presentation.website.Controllers
{
    ...
    public class InsurancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Created,Updated,IsActive")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Created,Updated,IsActive")] Insurance insurance)
        {
            if (ModelState.IsValid)
            {
