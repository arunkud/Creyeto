...
namespace ecom.presentation.website.Controllers
{
    public class ImageUploadController : Controller
    {
        ...
        [HttpGet]
        public ActionResult _ImageUpload()
        {
            return PartialView();
        }

        [ValidateAntiForgeryToken]
        public ActionResult _ImageUpload(IEnumerable<HttpPostedFileBase> files)
        {
        ...
        [HttpPost]
        public ActionResult ImageSave(string t, string l, string h, string w, string fileName)
        {
            try
            {
